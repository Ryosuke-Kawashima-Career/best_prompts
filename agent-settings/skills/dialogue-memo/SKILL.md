...
Automatically write a simple memo to `Q&A-Minute.md` so the user can quickly review the key points of the current Q&A exchange.

## 📝 Instructions

1. Trigger condition
   - If the user asks a question to the AI agent, you MUST write or update `Q&A-Minute.md`.
